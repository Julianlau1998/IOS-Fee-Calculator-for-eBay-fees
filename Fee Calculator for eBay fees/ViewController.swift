...
class ViewController: UIViewController, GADFullScreenContentDelegate {
    ...
    private let banner: GADBannerView = {
        ...
        banner.adUnitID = "ca-app-pub-1006221991146598/5384603011"
    ...
    override func viewDidLoad() {
        ...
        guard let url = URL(string: "https://ebay-calculator.netlify.app/") else {
            return
        }
    ...
    @objc func loadInterstitial() {
        let request = GADRequest()
            GADInterstitialAd.load(
              withAdUnitID: "ca-app-pub-1006221991146598/9132276331", request: request
            ) { (ad, error) in
              if let error = error {
